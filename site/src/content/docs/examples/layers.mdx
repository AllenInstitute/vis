...
4. `cd site/`
5. `pnpm run dev`
6. navigate to the running app (default `localhost:4321/vis`). you can click a link to a specific example in the docs, or just use the address bar (`localhost:4321/vis/examples/{path_to_desired_example}`)
