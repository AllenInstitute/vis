...
// A larger canvas Y means a larger data Y, matching how RenderServer lands frames on the canvas.
// Renderers that present frames some other way should convert the mouse themselves and use zoomAround.
 ...
 */
export function screenToData(view: box2D, screenSize: vec2, screenPos: vec2): vec2 {
 ...
 */
export function zoomAround(view: box2D, dataPoint: vec2, zoomScale: number): box2D {
 ...
 */
export function fitToScreen(imageSize: vec2, screenSize: vec2): box2D {
