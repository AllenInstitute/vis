...
describe("Vec3", () => {
	...
	test("normalize", () => {
		...
		expect(noLength).toStrictEqual([NaN, NaN, NaN]);
	});
	...
	test("finite", () => {
		...
		const infinityResult = Vec3.finite([Infinity, 2, 3]);
		expect(infinityResult).toBeFalsy();

		const nanResult = Vec3.finite([NaN, 2, 3]);
	...
	test("swizzle", () => {
		expect(Vec3.swizzle([111, 222, 33], [2, 1, 2])).toStrictEqual([
			33, 222, 33,
		]);
		expect(Vec3.swizzle([111, 222, 33], [0, 1, 0])).toStrictEqual([
			111, 222, 111,
		]);
		// dangerous cases:
		expect(Vec3.swizzle([111, 222, 33], [2, 1, 3])).toStrictEqual([
			33,
			222,
			undefined,
		]);
